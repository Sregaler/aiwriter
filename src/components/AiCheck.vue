    ...
    <div class="context-left col-md-2 col-xs-2">
      <div class="context-left-nav">
        <ul class="context-left-ul">
          <li class="left-li1">
            <img src="../assets/icon/修改1.svg" alt="" />图文成稿
          </li>
...
export default {
  ...
  methods: {
    ...
    sendCheckMsg() {
      ...
      axios
        .post("/baidu/review/ai_review", "data=" + innermsg)
        .then((res) => {
          if (res.data.ok) {
          ...
          axios
            ...
            .then((res) => {
              if (res.data.ok) {
                ...
                this.$alert("<strong>更新成功</strong>", "保存信息", {
  ...
  mounted() {
    // console.log(this.$refs.QWFormworkTextAi.innerText);
