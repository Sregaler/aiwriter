...
//            System.err.println("result:" + result);
     ...
     * 通用API访问获取
     */
    public static ResultVo jsonPostUrl(String url_name, String url, String accessToken, Map<String, Object> map, String encoding) {
        ...
        try {
            ...
            if(encoding==null)
                ...
                result = HttpUtil.post(url, accessToken, "application/json", param, encoding);
//            JSONObject jsonObject = new JSONObject(result);
//            if(jsonObject.getString("msg")=="success"){}
            resultVo.setMess(url_name);
            resultVo.setOk(true);
